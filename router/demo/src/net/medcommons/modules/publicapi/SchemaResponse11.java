...
public class SchemaResponse11 extends SchemaResponse {
	/**
	 * Logger to use with this class
	 */
	private static Logger log = Logger.getLogger("SchemaResponse11");
	String schemaURLToken = null;
	String xsdURI = "/EditSession11.xsd";
	String namespace = "http://www.medcommons.net/editsession11";
    ...
    */
	private ObjectPool validatingParserPool =
        new GenericObjectPool(
                        new ValidatingParserFactory("conf/EditSession11.xsd",namespace)); 
	
	public SchemaResponse11(String schemaURLToken){
    ...
    private Schema getSchema() throws SAXException {
        if(xmlSchema == null) {
            ...
            StreamSource ss = new StreamSource("conf/EditSession11.xsd");
