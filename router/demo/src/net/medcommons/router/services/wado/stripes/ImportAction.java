/*
 * $Id: ImportAction.java 3845 2010-09-14 08:52:52Z ssadedin $
...
public class ImportAction extends CCRActionBean {
    ...
    private Resolution showCCRResolution() {
        int ccrIndex = session.getActiveCCRIndex(ctx.getRequest());
        ctx.getRequest().setAttribute("ccrIndex", ccrIndex);
        ctx.getRequest().setAttribute("view", ccrIndex+"e");
