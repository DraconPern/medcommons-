...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      commandProxyBaseURL =  '<mc:config property="RemoteAccessAddress"/>/ddl';
      ...
      withWindow(parent,function() {
          removeElementClass('attacheddocsmenu', 'hidden');
      });
    </script>
  </head>
  <mc:xnode bean='notificationForm' path='patientAge' name='patientAge'/>
  <body onload="init();" style="height: 100%;" class="yui-skin-mc" style="z-index: 0;">
  ...
  <form name="referralForm" id="referralForm" method="post" onsubmit="return goReferralEmail();" action="/router/confirmReferral.do" target="referralEmail">
    ...
    <script src="yui-2.8.2r1/yuiloader/yuiloader-min.js"></script> 
