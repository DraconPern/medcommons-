...
<c:if test='${!empty ccr}'>
  ...
  <c:set var='gadgets'>
  <pack:style>
    <src>/yui-2.8.2r1/datatable/assets/skins/sam/datatable.css</src>
    <src>/yui-2.8.2r1/paginator/assets/skins/sam/paginator.css</src>
  </pack:style>

  <pack:script>
      <src>yui-2.8.2r1/utilities/utilities.js</src>
      <src>yui-2.8.2r1/datasource/datasource-min.js</src>
      <src>yui-2.8.2r1/datatable/datatable-min.js</src>
      <src>yui-2.8.2r1/logger/logger-min.js</src>
      <src>yui-2.8.2r1/paginator/paginator-min.js</src>
