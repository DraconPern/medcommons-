...
<html>
  <head>
    ...
    <%--
    <link rel='stylesheet' type='text/css' href='yui-2.8.2r1/menu/assets/skins/mc/menu.css'/>
    --%>
    <pack:style src="yui-2.8.2r1/menu/assets/skins/mc/menu.css"/>
    ...
    <script language="JavaScript">
      ...
      function initTabs() {
        ...
        if(!window.opener)
            removeElementClass('backImg','hidden');
      }
  ...
  <body style="height: 100%; overflow: hidden;" class="yui-skin-mc" onload="initTabs();">
    ...
    <div id="tabs" class="lightBackground" style="height: 30px; width: 100%; vertical-align: bottom;" > 
        ...
        <a href='${accountsBaseUrl}/acct/index.php' id='backImg' title='Back to Main Page' class='hidden'><img src='images/home.png'/></a>
    ...
    <div id="menu" class="yuimenubar yuimenubarnav" style='z-index: 1000000;'>
        <div class="bd">
            <ul class="first-of-type" style='border-style-top: none;'>
                <li class="yuimenubaritem first-of-type"><a class="yuimenubaritemlabel" href="#" onclick='return false;'>Actions</a></li>
                <li class="yuimenubaritem hidden" id='attacheddocsmenu'><a class="yuimenubaritemlabel" href="#" onclick='return false;'>CCR Attached Documents</a></li>
    ...
    <c:if test='${desktop.accessMode == "ACCOUNT_IMPORT_RESULT"}'>
      <s:layout-render name="/infobar.jsp">
        <s:layout-component name="contents"><b>Verify the result of your import below.</s:layout-component>
      </s:layout-render>
    </c:if>
