...
// Copy the main skin 
ant.copy(todir: "assets/skins/mc") {
  fileset(dir:"assets/skins/sam")
}
...
ant.copy(todir: "assets/skins/mc", overwrite:true) {
  fileset(dir: "../yui-customizations") {
    include(name: "sprite.png")
    include(name: "bg-h.gif")
  }
}
