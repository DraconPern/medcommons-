...
public class UserSession implements Serializable, HttpSessionBindingListener {
     ...
     */
    private transient ServicesFactory factory = null;
    ...
    public ServicesFactory getServicesFactory() throws ServiceException {
        if(factory == null) {
            ...
            if(!blank(this.getContextAuth()) && !Str.eq(this.getContextAuth(), this.getAuthenticationToken())) {
                factory.setAuthContext(this.getContextAuth());
            }
        } 
        return factory;
    }
    ...
    public StoreTransaction tx(CCRDocument ccr) throws CCRStoreException, ServiceException {
        ...
        try {
            ...
            if(blank(patientMcId))
                patientMcId = ServiceConstants.PUBLIC_MEDCOMMONS_ID;
