...
-->
  ...
  <fieldset>
    <legend>Account Expiry</legend>
    <logic:present name='actionBean'>
	    <span class="statusLabel">Accounts Expired</span>: <span class="statusValue">${actionBean.expiredAccounts}</span><br/>
	    <span class="statusLabel">Expiry Errors</span>: <span class="statusValue">${actionBean.expirationFailures}</span><br/>
    </logic:present>
  </fieldset>
