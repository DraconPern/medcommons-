...
<html>
   <head>
    ...
    <mc:base/>
    <meta name="viewport" content="maximum-scale=1.0,minimum-scale=1.0"></meta>
    <pack:style>
      <src>common.css</src>
      <src>WADO.css</src> 
      <src>forms.css</src> 
    ...
    <script type="text/javascript">
      ...
      var MAX_SPRITE_HEIGHT = <%= WADOImage2.MAX_SPRITE_HEIGHT %>;
      ...
      <tiles:insert page="patientJavascript.jsp"/>
    ...
    <script type="text/javascript">
      ...
      thumbnails[0]=new CautionThumbnail(ccr, p.studies[0].series[0]);
      ...
      if(currentSeries >= p.studies[0].series.length) {
        currentSeries = p.studies[0].series.length-1;
  ...
  <body 
      ...
      <%--  onkeydown="handleKeyDown(event);"   onkeypress="handleKeyPress(event);"   --%> 
