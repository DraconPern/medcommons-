...
<html>
   <head>
    ...
    <script type="text/javascript">
      ...
      //window.parent.setTabIcon(null, '<img class="tabIcon" title="Switch to Edit Mode" style="position: relative; top: -1px; left: 3px;" src="images/editpad.gif"/>');
      //window.parent.setTabIcon(null, '<img class="tabIcon" title="Switch to Edit Mode" style="position: relative; top: 1px; left: 3px;" src="images/redcycle.gif"/>');
