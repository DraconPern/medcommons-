...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
            ...
            <html>
                  <head>
                        ...
                        <xsl:comment> do NOT edit this HTML directly, it was generated via an XSLT
                              transformation from the original Level 1 document. </xsl:comment>
                        <style>
                              <xsl:comment> body {color: black; }
                                    <!--div div { margin: 4px 0 4px 0.1in; padding: 0; }-->
                                    <!--ul { margin: -4px 0 -8px 0 ; padding: 0; }--> p { margin:
                                    10px 0 10px 0.25in; } div.caption { font-weight: bold;
                                    text-decoration: underline; } span.caption { font-weight: bold;
                                    } div.title { font-size: 18pt; font-weight: bold }
                                    div.demographics { text-align: center ; } </xsl:comment>
                        </style>
                        <title>
  ...
  -->
      <xsl:template match="observation_media">
            <xsl:if test="observation_media.value[    @MT=&quot;image/gif&quot; or @MT=&quot;image/jpeg&quot;    ]">
                  <br clear="all"/>
...
-->
  ...
  -->
	 ...
	 e.g., 1999-12-07  ==> December 07, 1999
  -->
