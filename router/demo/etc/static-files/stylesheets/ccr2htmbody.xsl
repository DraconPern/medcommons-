...
<xsl:stylesheet exclude-result-prefixes="a date" version="1.0" xmlns:a="urn:astm-org:CCR"
  ...
  <xsl:template match="/">
      <div class='ccrreport'>
        <table xmlns:date="http://exslt.org/dates-and-times" id="ccrtable" cellPadding="1" cellSpacing="1">
          <tbody>
            <tr>
              <td>
                  ...
                  <tbody>
                    <tr id="ccrheaderrow">
                      <td>
                        ...
                        <table cellPadding="1" cellSpacing="3" id="ccrheader" width="75%">
                          <tbody>
                            <tr>
                              <td>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <xsl:if test="string-length(normalize-space(a:ContinuityOfCareRecord/a:Purpose/a:Description/a:Text))!=0">
                                  <br/>
                                </xsl:if>
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Comments/a:Comment[a:Type/a:Text='MedCommons User Comment']/a:Description/a:Text[string-length(.)!=0]">
                                  <span class="commentHeading">Comment</span>
                                  <br/>
                                  <xsl:value-of select="."/>
                                </xsl:for-each>
                              </td>
                              ...
                              <xsl:for-each select="/a:ContinuityOfCareRecord/a:Actors/a:Actor">
                                ...
                                <xsl:if test="$objID = $thisObjID">
                                  <tr>
                                    ...
                                    <td><a href='javascript:parent.showDemographicsForm()' id='editDemoGraphicsLink' style='display: none;'><img border="0" src='images/editpad.gif'/></a></td>
                                  </tr>
                                </xsl:if>
                              </xsl:for-each>
                            </xsl:for-each>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Support">
                        <tr id="supportprovidersrow">
                          <td>
                            ...
                            <br/>
                            <table id="supportproviders" class="list">
                              <tbody>
                                <tr>
                                  <th>Role</th>
                                  <th>Name</th>
                              ...
                              <tbody>
                                ...
                                <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:Procedures/a:Procedure">
                                  <tr id='{a:CCRDataObjectID}'>
                                    ...
                                    <td>
                                      <xsl:value-of select="a:IDs/a:ID"/>
                                    </td>
                                  </tr>
                                </xsl:for-each>
                              </tbody>
                      ...
                      <xsl:if test="a:ContinuityOfCareRecord/a:Body/a:Medications">
                        <tr id="medicationsrow">
                          <td>
                            ...
                            <br/>
                            <table class="list" id="medications">
                              <tbody>
                                <tr>
                                  <th>Medication</th>
                                  <th>Date</th>
                                  ...
                                  <xsl:for-each select="a:ContinuityOfCareRecord/a:Body/a:PlanOfCare/a:Plan[a:Type/a:Text='Order']">
                                    <tr id='{a:CCRDataObjectID}'>
                                      <td>
                                        ...
                                        <xsl:if test="string-length(normalize-space(a:Description/a:Text))!=0">
                                          <br/>
                                        </xsl:if>
                                      ...
                                      <td>
                                        <xsl:value-of select="a:OrderRequest/a:Procedures/a:Procedure/a:IDs/a:ID"/>
                                      </td>
                                    </tr>
                                  </xsl:for-each>
                                </tbody>
                                  ...
                                  <tr id='{a:CCRDataObjectID}'>
                                    ...
                                    <td>
                                      <a>
                                        <xsl:attribute name="href">
                                          <xsl:text>#</xsl:text>
                                          <xsl:value-of select="a:Source/a:ActorID"/>
                                        </xsl:attribute>
                                        <xsl:call-template name="actorName">
                                          <xsl:with-param name="objID" select="a:Source/a:ActorID"/>
                                        </xsl:call-template>
                                      </a>
                                    </td>
                                  </tr>
...
<!--  This is from the EXSLT.org Library -->
<date:months>
        ...
        <xsl:otherwise>
          ...
          <xsl:variable name="timezone">
            <xsl:choose>
              ...
              <xsl:when test="substring($no-neg, $no-neg-length - 3) = ':'">
          ...
          <td>
            <xsl:for-each select="$dt/a:DateTimeRange/a:BeginRange">
              <xsl:choose>
                ...
                <xsl:when test="a:ApproximateDateTime">
                  <xsl:value-of select="a:ApproximateDateTime/a:Text"/>
                </xsl:when>
                <xsl:otherwise/>
              </xsl:choose>
            </xsl:for-each>
        ...
        <tr>
          <td>
            <font color="#CCCCCC" size="3">
              <strong>Powered by the <a
                  href="http://www.astm.org/cgi-bin/SoftCart.exe/DATABASE.CART/REDLINE_PAGES/E2369.htm?E+mystore" style="color:#CCCCCC;">ASTM E2369-05 Specification for the Continuity of Care Record (CCR)</a>
              </strong>
            </font>
          </td>
        </tr>
