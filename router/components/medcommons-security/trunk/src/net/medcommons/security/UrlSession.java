/*
 * net/medcommons/crypto.UrlSession.java
...
/**
 * Encrypt, timestamp, and sign URLs and query strings.
 *
 * A web server can redirect to another webserver such that:
 * <ul>
 *  <li>Private information can be encoded in the URL;  </li>
 *  <li>The remote web server can test whether the URL originated
 *      from the correct sender (hackers can't generate URLS to go fishing)</ul>
 *  <li>The remote web server can test whether the URL originated
 *      relatively recently (to prevent replay attacks)</li>
 * </ul>
 *
 * An originating web server calls these three functions:
 * <ol>
 *  <li>TimestampURL - given a URL or query string</li>
 *  <li>AddEncryptedQueryString - given a query string containing private data</li>
 *  <li>SignQueryString</li>
 * </ol>
 *
 * The result URL can be then displayed on a web page.
 *
 * The recipient web server calls these three functions:
 * <ol>
 *  <li>IsQueryStringCurrent</li>
 *  <li>GetEncryptedQueryString</li>
 *  <li>IsSignedQueryStringValid</li>
 * </ol>
 *
...
public class UrlSession {
    ...
    static FileInputStream urandom = null;
    ...
    if(urandom == null) { // not thread safe, but who cares?
        if(Configuration.getProperty("SoftUrandom", false)) {
            softUrandom = true;
        }
        else {
            try {
