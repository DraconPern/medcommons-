...
public class DatabaseImpl extends AbstractDatabase {
	...
	protected PreparedStatement getAutoIncrementRetrievalStatement(Connection c) throws SQLException {
    	return c.prepareStatement("CALL IDENTITY()");
	}
    ...
    protected int autoIncrementColumnNumber() {
        ...
        return super.autoIncrementColumnNumber();
    }
    ...
    @Override
    protected PreparedStatement getCreateTableStatement(Connection c, String tableName, FieldDescriptor fd,
            boolean autoIncrementRequested) throws SQLException {
        
        return c.prepareStatement ("CREATE TABLE " + tableName + " (" + fd.getName() + " IDENTITY)");
