package net.medcommons.modules.utils.dicom;
...
public class DicomNameParser {
	...
	*/ 
	...
	public static class DicomName {
	    public String given;
	    public String middle;
	    public String family;
	}
	
	public static DicomName parse(String dicomName) {
	    DicomNameParser dnp = new DicomNameParser();
	    DicomName result = new DicomName();
	    result.given = dnp.givenName(dicomName);
	    result.middle = dnp.middleName(dicomName);
	    result.family = dnp.familyName(dicomName);
	    return result;
	}

	/**
	 * Translates the sex from DICOM format to the form
	 * used in the CCR.  Specifically:
	 * 
	 *  <ul>
	 *     <li>M => Male
	 *     <li>F => Female
	 *     <li>Anything else => Other
	 *  </ul>
	 *
	 * @param patientSex
	 * @return
	 */
    public static String parseSex(String patientSex) {
