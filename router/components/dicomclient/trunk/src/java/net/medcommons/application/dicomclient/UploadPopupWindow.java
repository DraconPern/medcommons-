...
import net.medcommons.application.dicomclient.utils.TrayImages;
...
public class UploadPopupWindow extends JFrame implements ActionListener,StatusUpdate{
	...
	public UploadPopupWindow(){
		...
		public void init() {
			...
			Image dodImage = TrayImages.loadImage(dicomOnDemandFile);
			Image mcImage = TrayImages.loadImage(medcommonsLogoFile);
