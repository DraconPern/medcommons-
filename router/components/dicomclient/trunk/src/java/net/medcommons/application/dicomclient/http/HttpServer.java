...
public class HttpServer {
	...
	public HttpServer () throws Exception {
	    ...
	    Context crossDomain = new Context(contexts,"/",Context.SESSIONS);
	    crossDomain.addServlet("net.medcommons.application.dicomclient.http.HttpServer$CrossDomainServlet", "/crossdomain.xml");
	}
	...
	/**
	 * Serves up a cross domain xml file to let applets communicate locally as well
	 * as with the web site that hosts DDL
	 */
	public static class CrossDomainServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request,
            ...
            log.info("crossdomain.xml requested");
            response.setStatus(HttpServletResponse.SC_OK);
