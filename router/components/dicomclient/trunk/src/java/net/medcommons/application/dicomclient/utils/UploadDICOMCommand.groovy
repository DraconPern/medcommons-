    ...
    public Future<JSONObject> execute(CommandBlock params) {
	    ...
	    new Thread({
	        ...
	        try {
                ...
                if(props.anonProfile == 'aptus') {
                    // props.accessionNumber = "123-accnum-12345"
                    // props.patientId = "123-patid-12345"
                    anon = new AptusAnonymizer(props);
                }
    	        ...
    	        uploadDir(dir, status, anon) { DicomObject dcm -> 
    		        if(!seriesUIDs)
    		            return true
