 ...
 *
 */
public class CCRPatientReference extends CCRRef{
	String givenName = "Unknown";
	String familyName= "Unknown";
	String groupName= "Unknown";

	public CCRPatientReference(CCRRef ccrReference, PixDemographicData pixDemographicData, PixIdentifierData pixIdentifierData){
