...
public class CommandBlock {
	...
	public CommandBlock addProperty(String name, String value){
	...
	public String urlRequest(){
		...
		while(names.hasMoreElements()){
			...
			if((String)properties.get(name) != null) {
	...
	public ContextState toContextState() {
		...
		contextState.setApplianceRoot(this.getProperty("applianceRoot"));
