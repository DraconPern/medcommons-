...
public enum ResourceName {
	...
	ALLOW_SELF_SIGNED_CERTS("AllowSelfSignedCerts", "Whether SSL connections should accept self-signed certs (less secure)", "true"),
	USE_RAW_FILE_UPLOADS("UseRawFileUploads", "If enabled uses more efficient Multipart Form protocol for uploading DICOM", "true"),
	PROXY_AUTH_USER_NAME("ProxyAuthUserName", "User name for proxy authentication", ""),
	PROXY_ADDRESS("ProxyAddress", "Proxy address", ""),
	PROXY_AUTH_PASSWORD("ProxyAuthPassword", "Proxy password", ""),
	USE_GZIP("UseGZIP", "If enabled uses GZIP as generic compression mechanism when sending images", "true");
