...
public class ScanFolderCommand implements Command {
        ...
        SwingUtilities.invokeLater {
	        new DicomFileChooser(null,true,{ File dir, DICOMImportStatus status ->
                ...
                try {
			        ...
			        json = scanDir(dir)
			        json.put("selectedLocation", selectedLocation.absolutePath)
			            .put("status","ok")
    ...
    def scanDir(File dir) {
        ...
        dir.eachFileRecurse { f ->
            ...
            study.patientNames.add(ExtractFileMetadata.extractPatientName(dcm))
        ...
        return new JSONObject().put("studies", json)
