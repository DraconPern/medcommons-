...
/**
 * A DICOM export scheduled and queued for execution.
 * <p>
 * A {@link DicomOutputTransaction} is linked to a {@link CxpTransaction} by
 * its {@link #cxpJob} property which identifies the id of the {@link CxpTransaction}
 * which downloaded the data that is to be exported.
 * 
 * @author ssadedin
 */
@PersistentClass(table="dicom_output_transaction", idField="id", autoIncrement=true,
        indexes={ @PropertyIndex(unique=false,propertyNames={"cxpJob"}) }
)
