...
public class ConfigUpdateActionBean extends DDLActionBean implements Commands {
	...
	boolean useRawFileUploads = true;
	...
	public Resolution update() throws IOException {
		...
		configs.setProxyAddress(proxyAddress);
		configs.setProxyAuthUserName(proxyAuthUserName);
		configs.setProxyAuthPassword(proxyAuthPassword);
		configs.setUseRawFileUploads(useRawFileUploads);
