 ...
 */
package net.medcommons.phr.util;
 ...
 * 
 * NOTE: this class is copied from the gateway code verbatim.   Some day we will probably make some 
 * kind of commons or base util component and clean all these things into there.
 * 
 * @author ssadedin
 */
     ...
     */
     public static String toString(Element e) {
         try {
             ...
             return "Exception while rendering value of " + e + " :" + e1;
         }
     }
}
