...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="yui-2.6.0/menu/assets/skins/sam/menu.css"> 

    <!-- Dependencies -->  
    <script type="text/javascript" src="yui-2.6.0/yahoo-dom-event/yahoo-dom-event.js"></script> 
    <script type="text/javascript" src="yui-2.6.0/container/container_core-min.js"></script> 
     
    <!-- Source File --> 
    <script type='text/javascript' src='yui-2.6.0/menu/menu-min.js'></script>
