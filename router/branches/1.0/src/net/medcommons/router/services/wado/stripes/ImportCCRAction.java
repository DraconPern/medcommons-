/*
 * $Id: ImportCCRAction.java 3736 2010-06-03 11:21:01Z ssadedin $
 */
...
public class ImportCCRAction extends BaseActionBean {
    ...
    public Resolution upload() throws Exception {
        ...
        String ccrXml = IOUtils.toString(uploadedFile.getInputStream());
        ...
        try {
            ...
            request.setAttribute("message", session.getMessage("medcommons.invalidCcr"));
        ...
        String accid = desktop.getOwnerMedCommonsId();
        
        CCRDocument newCCR = null;
        
        try{
        	newCCR = new CCRDocument(accid, null, null, ccrXml, CCRDocument.SCHEMA_VALIDATION_STRICT);
        }
