...
public class XPathUtils {
	...
	public static String getSingleValue(Document document, String pathName)
        ...
        try {
            ...
            Object pathResult = xpath.getXPathResult(document, pathName, Collections.EMPTY_MAP, false);
            if (pathResult == null)
            	return null;
            ...
            if (pathResult instanceof List) {
            	...
            	throw new MultipleElementException(buff.toString());
            }

            return (getAtomicValue(pathName, pathResult));
        }
        catch (JDOMException e) {
            throw new PHRException("Error querying PHR value " + pathName);
        }
	}
	...
	public static List getValues(Document document, String pathName)
        ...
        XPathCache xpath = (XPathCache) Configuration.getBean("ccrXPathCache");
		return (List) xpath.getXPathResult(document, pathName,
	 ...
	 * @throws PHRException 
	 */
	public static String getValue(Document document, String pathName) throws PHRException {
        try {
            XPathCache xpath = (XPathCache) Configuration.getBean("ccrXPathCache");
            Object pathResult = xpath.getXPathResult(document, pathName,
	...
	public static void setValue(Document document, String pathName, String value) throws PHRException {
        try {
            XPathCache xpath = (XPathCache) Configuration.getBean("ccrXPathCache");
            Object pathResult = xpath.getXPathResult(document, pathName,
            		Collections.EMPTY_MAP, false);
