				...
				<xsl:when test="position() mod 2=0">
					<tr class="even">
						<xsl:choose>
							...
							<xsl:otherwise>
								<td>
									<xsl:value-of select="a:Dose/a:Value"/><![CDATA[ ]]><xsl:value-of select="a:Dose/a:Units/a:Unit"/><![CDATA[ ]]><xsl:value-of select="a:Route/a:Text"/><![CDATA[ ]]><xsl:value-of select="a:Frequency/a:Value"/>
									<xsl:if test="a:Duration"><![CDATA[ ]]>(for <xsl:value-of select="a:Duration/a:Value"/><![CDATA[ ]]><xsl:value-of select="a:Duration/a:Units/a:Unit"/>)
																								</xsl:if>
								</td>
