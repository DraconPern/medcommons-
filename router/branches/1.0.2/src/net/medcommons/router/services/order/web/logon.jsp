  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function submitOpenId() { 
        window.open("AuthenticateOpenID.action?waitForProvider","openid_auth","width=800,height=600,location=no,menubar=no,status=no,toolbar=no");
        return false;
      }
    </script>
  </head>
        ...
        <c:when test='${not desktop.hasAccount or  not empty trackingNumber}'>
          ...
          <div>
            ...
            <div id="openidblock" style="padding-top: 45px; height: 100px;">
	          <%--
		           This form doesn't submit directly.  Actuallly a Javascript handler aborts it and
		           opens a new window which resubmits it via javascript from there - 
		           see validatingOpenId.ftl
	           --%>
