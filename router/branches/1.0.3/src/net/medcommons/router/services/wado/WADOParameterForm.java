...
public class WADOParameterForm extends ActionForm {
  ...
  private String windowLevelGrid = null;
  ...
  public String toString() {
    ...
    /**
     * @return Returns the levelGridArray.
     * 
     * @uml.property name="levelGridArray"
     */
    public int[] getLevelGridArray() {
        return levelGridArray;
    }

    /**
     * @param levelGridArray The levelGridArray to set.
     * 
     * @uml.property name="levelGridArray"
     */
    public void setLevelGridArray(int[] levelGridArray) {
	...
	public void adjust() {
		...
		if (this.windowLevelGrid != null) {
			StringTokenizer tok =
				new StringTokenizer(this.windowLevelGrid, ",");
			int i = 0;
			this.windowGridArray = new int[9];
			this.levelGridArray = new int[9];
			//System.out.println("url: " + this.windowLevelGrid);
			while (tok.hasMoreTokens()) {
				try {
					...
					this.windowGridArray[i] = w;
					this.levelGridArray[i] = l;
					i++;
				} catch (Exception e) {
					e.printStackTrace();
					this.windowGridArray[i] = i * 100;
					this.levelGridArray[i] = i * 100;
				}
			}
		}
	}
  ...
  public String getRegion() {
    ...
    /**
     * @return Returns the windowGridArray.
     * 
     * @uml.property name="windowGridArray"
     */
    public int[] getWindowGridArray() {
        return windowGridArray;
    }

    /**
     * @param windowGridArray
     *          The windowGridArray to set.
     * 
     * @uml.property name="windowGridArray"
     */
    public void setWindowGridArray(int[] windowGridArray) {
        this.windowGridArray = windowGridArray;
    }

    /**
     * @return Returns the windowLevelGrid.
     * 
     * @uml.property name="windowLevelGrid"
     */
    public String getWindowLevelGrid() {
        return windowLevelGrid;
    }

    /**
     * @param windowLevelGrid
     *          The windowLevelGrid to set.
     * 
     * @uml.property name="windowLevelGrid"
     */
    public void setWindowLevelGrid(String windowLevelGrid) {
