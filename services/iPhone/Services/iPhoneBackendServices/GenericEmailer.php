...
EOF;
  ...
  $headers = <<<EOF
From: BigApp Foto Vault <billdonner@gmail.com>
Reply-To: noreply@medcommons.net
...
class GenericEmailer extends jsonrestws {
...
$html .=<<<XXX
<p>The associated set of documents and photos 
can be viewed <a href='$pickupurl?voucherid=$voucherid&pin=$pin'>here</a></p>
XXX;

send_mc_email($emailaddr,
	      $subject, $text, $html,
...
$x = new GenericEmailer();
$x->handlews("GenericEmailer");
?>
