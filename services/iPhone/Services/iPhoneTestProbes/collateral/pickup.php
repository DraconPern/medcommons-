...
<html>
<head><title>MedCommons Forensic Photo Media Vault</title>
...
<h4>Forensic Photo Media Vault</h4>
...
";
	$clause = ''; $sbtitle = "Forensic Photo Media Series";
...
Voucher ID: <input type=text value ='' name=voucher size = 10><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PIN: <input type=text value='' name = pin size = 10><br/>
<br/>
...
while ($r = mysql_fetch_object($result))
{
	...
	<div>$mcred</div>
	<div class=shoot_time>Shot at $r->iphonetime on iphone #:$r->uid </div>
	<div>By $sender</div>
	...
	while ($r2 = mysql_fetch_object($result2))
	{
		if ($r2->reqop == "subject_photo")
		{
			...
			$out .= "<div class='solo_image'><a href='pickup.php?uid={$r2->uid}' ><img alt='{$r2->filesuffix}' src='{$r2->reqdata}' /></a></div>\n";
		}
		else
