...
function flipToFront(event)
{
    ...
    if (views && views.object && front) {
      if(getCookie('mc'))
        mc.log ("Presenting Front View to User with Cookie set"); else
...
// make the patient described in p be the current patient
 ...
 function gotoCurrentPatient()
 {
   ...
   document.getElementById('patientMcid').innerText=ctx.patientid;
    ...
    mc.log ("Present Patient View for "+ctx.patientid); views.object.setCurrentView(document.getElementById('onepatient'),true,true);
}
            ...
            jQuery.getJSON(mc_rest('ws/ijsconsentslist.php'),
                ...
                if(res.status != 'ok') {                
                   ...
                   loginError(res.message);
                    ...
                    {         updateConsentsList (res.ccrs); // = user
                    }
                   });
                 } //load consentsList
            ...
            jQuery.getJSON(mc_rest('ws/ijsdocumentslist.php'),
                ...
                if(res.status != 'ok') {                
                   ...
                   loginError(res.message);
                    ...
                    {         updateDocumentsList (res.ccrs); // = user
                    }
                   });
                 } //load documentsList
