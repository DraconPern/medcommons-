...
@synthesize hurl = _hurl; // shows implicit status by coloring the display
...
/*
 ------------------------------------------------------------------------
 mcUrlConnectionDelegate protocol methods
 ------------------------------------------------------------------------
 */

#pragma mark -
#pragma mark mcUrlConnectionDelegate methods, these come back in patient context
