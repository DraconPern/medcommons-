...
";
	$first=true;
	$result = dosql("Select * from _viewerorder where layout='$layout' order by displayorder ");
...
$result = dosql("Select distinct ddtable from _viewerorder");
...
$result = dosql("Select * from _viewerorder");
...
XXX;
	...
	$result2 = dosql("Select * from _datadictionary where ddtable='$tabkey' "); else

	$result2 = dosql("Select * from _datadictionary where tabkey = '$tabkey' order by ddtable,tabkey,pane,line ");
...
$result = dosql("Select distinct layout from _viewerorder");
while ($r = mysql_fetch_object($result))
echo code($r->layout)."
