...
XXX;
	...
	if ($logged_in === false)
	{
/* on website not logged on */
		$navcontainer = <<<XXX
<li><a class=menu_how href="/index.php">Home</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
<li ><a class=menu_nil  href="/pickuprecords.php" >Pickup Records</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
<li ><a class=menu_nil  href="http://apps.facebook.com/medcommons" >Facebook App</a></li>&nbsp;&nbsp;|&nbsp;&nbsp;
<li ><a class=menu_nil  href="http://www.medcommons.net/login/" >Sign In</a></li>
XXX;
}
else
{
...
/*container for logged on website users*/
	$navcontainer = <<<XXX
...
$names = array('$$$htmltitle$$$','$$$navcontainer$$$','$$$topright$$$', '$$$globalredirector$$$', '$$$loginpage$$$','$$$pageid$$$',
'$$$modcomments$$$','$$$locallogin$$$','$$$purchasedisabled$$$');
$values = array($maintitle,$navcontainer,$topright, $GLOBALREDIRECTOR, $GLOBALS['global_login_url'],$pagename,$comments
,$GLOBALS['footerlogin'] ,$purchasedisabled);
foreach($vars as $n => $v) {
	$names[]='$$$'.$n.'$$$';
	$values[]=$v;
}
