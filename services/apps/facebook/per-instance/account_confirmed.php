...
$result = mysql_query("update users set storage_account_claimed = 1 where fbid = ".$fbid);
if(!$result)
  throw new Exception("Failed to update users with new storage_account_claimed flag: ".mysql_error());
