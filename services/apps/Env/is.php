...
function isheader($title,$priv){
	{
		$private =$priv?"<p>Restricted page - requires privilege to access</p>":"";
...
<div  class="clearfix">
		<h1 class="logo-text">
			<a href="http://www.medcommons.net/index.php" target=showframe title="MedCommons Simtrak Navigator"><span>Simtrak Navigator 0.2</span></a>	
		</h1>
		<p class="site-slogan">Connected. Secure. Complete.</p>
</div>
...
XXX;
		...
		<div id='is_header'>
		$mimg
		<a href='is.php' >MedCommons Simtrak Admin</a>
		...
		<a href='l.php?leagueind=6'>jla</a>
...
//$require_check= isset($GLOBALS['openid_hack']) ? false : true;
