...
{
	$result = dosql("Select name from leagues l ,leagueteams lt where lt.teamind = '$ind' and l.ind=lt.leagueind ");
	$rr = isdb_fetch_object($result);
	if ($rr==false) return false; else return $rr->name;
}
function leaguenamefromind ($ind)
{
	$result = dosql("Select * from leagues where ind = '$ind'");
	$rr = isdb_fetch_object($result);
	if ($rr==false) return false; else return $rr->name;
}
...
{
	if ($my_role=='is') $mimg = "<a href='is.php'><img  src='http://www.medcommons.net/images/MEDcommons_logo_246x50_Tran.gif' alt='main logo'/></a>
	"; else $mimg = "<a href='#'><img  src='http://www.medcommons.net/images/MEDcommons_logo_246x50_Tran.gif'  alt = 'main.logo' /></a>
	";
...
<img src='$imgurl' ></a>";
else 	$leagueimg = "<a href='#' title='you are signed on as $myid role $my_role' ><img src='$imgurl' ></a>";
