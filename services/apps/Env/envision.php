...
if ($mcid_==0) { 
	...
	require_once "admin.inc.php"; envision_admin_page(); // this is url processing gets done for the variou7s postbacks
}
// otherwise, the fast_path
else die("viewer_plugin($admin)"); // mcid is hidden variable
?>
