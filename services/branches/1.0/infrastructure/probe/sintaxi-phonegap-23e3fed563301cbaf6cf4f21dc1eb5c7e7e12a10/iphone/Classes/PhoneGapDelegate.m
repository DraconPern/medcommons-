...
- (id) init 
{ /* patched in by donner http://groups.google.com/group/phonegap/browse_thread/thread/852d8a68b8131d8b */
    self = [super init]; 
    if (self != nil) { 
        commandObjects = [[NSMutableDictionary alloc] initWithCapacity: 
						  4]; 
