...
cp ${FB_ROOT}/services/${FB_TRUNK}/daemons/mc_backups/*.py $DST/opt/mc_backups &&
cp ${FB_ROOT}/services/${FB_TRUNK}/daemons/mc_backups/*.rc $DST/opt/mc_backups &&
cp ${FB_ROOT}/services/${FB_TRUNK}/daemons/mc_backups/mc_backups $DST/etc/init.d &&
