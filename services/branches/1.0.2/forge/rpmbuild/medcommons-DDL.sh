...
jar xf ${FB_ROOT}/router/components/dicomclient/trunk/build/jnlp/DDL.war &&
popd &&
cp ${FB_ROOT}/services/${FB_TRUNK}/config/linux/common/etc/httpd/conf.d/ddl_ajp.conf $DST/etc/httpd/conf.d &&	
