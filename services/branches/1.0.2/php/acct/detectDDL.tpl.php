...
?><div id='wholeStep1' <?if(req("step") && req("step")!="1"):?>class='hidden'<?endif;?> >
    ...
    <div id='step1boxes' class='section'>
        ...
        <p class='middled hidden startsec' id='waiting'><img src='images/bigloading.gif'/> &nbsp;
            Please approve security questions as they come up.  The installation may take a few minutes.</p>
        ...
        <div id='installDDLStep' class='hidden startsec'>
            <p id='unableToConnectMsg' class='hidden'>We were unable to connect to your Transfer Utility. Please click the button below to start it fresh.</p>
            <p><button id='startDDLLink'>Start Transfer Utility</button></p>
        </div>
        ...
        <div id='restartingDDL startsec' class='hidden'>
