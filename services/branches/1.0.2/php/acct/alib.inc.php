...
function get_validated_account_info() {
	...
	return get_full_account_info($info);
}
 ...
 */
function get_full_account_info($info) {
  try {
...
{
  $sql = "SELECT q.*,i.accid, ga.adminaccid, i.enable_uploads from practice q, groupmembers p, users u, groupinstances i
