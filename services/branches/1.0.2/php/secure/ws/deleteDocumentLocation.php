...
class deleteDocumentLocationWs extends securedbrestws {
	function xmlbody() {
    ...
    $nodeId = $node->node_id;
		...
		// echo inputs
		$this->xm($this->xmnest("inputs", $this->xmfield("node", $nodeId).
		...
		// return outputs
		$this->xm($this->xmnest("outputs", $this->xmfield("docid", $docid).
