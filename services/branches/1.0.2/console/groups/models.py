...
class Group(models.Model):
    ...
    groupLogo = models.CharField(max_length=765)
    adminUrl = models.CharField(max_length=765)
    memberUrl = models.CharField(max_length=765)
    parentid = models.IntegerField(default=0)
    accid = models.CharField(max_length=16) # models.ForeignKey(User, db_column='accid')
...
class Practice(models.Model):
    ...
    practicename = models.CharField(max_length=96)
    providergroupid = models.ForeignKey(Group, db_column='providergroupid', null=True)
    practiceRlsUrl = models.CharField(max_length=765)
    practiceLogoUrl = models.CharField(max_length=765)
    accid = models.CharField(max_length=16) #models.ForeignKey(User, db_column='accid')
    class Meta:
        db_table = 'practice'
...
class Practiceccrevent(models.Model):
    ...
    PatientGivenName = models.CharField(max_length=192)
    PatientFamilyName = models.CharField(max_length=192)
    PatientIdentifier = models.CharField(max_length=192)
    PatientIdentifierSource = models.CharField(max_length=192)
    Guid = models.CharField(max_length=192, primary_key=True)
    Purpose = models.CharField(max_length=192)
    SenderProviderId = models.CharField(max_length=192)
    ReceiverProviderId = models.CharField(max_length=192)
    DOB = models.CharField(max_length=192)
    CXPServerURL = models.CharField(max_length=765)
    CXPServerVendor = models.CharField(max_length=765)
    ViewerURL = models.CharField(max_length=765)
    Comment = models.CharField(max_length=765)
    CreationDateTime = models.IntegerField()
    ConfirmationCode = models.CharField(max_length=192)
    RegistrySecret = models.CharField(max_length=192)
    PatientSex = models.CharField(blank=True, max_length=192)
    PatientAge = models.CharField(blank=True, max_length=192)
    Status = models.CharField(blank=True, max_length=90)
    ViewStatus = models.CharField(blank=True, max_length=60)
    class Meta:
