...
CREATE TABLE `clicktracks` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM COMMENT='click table' AUTO_INCREMENT=1588 ;
...
CREATE TABLE `cxpproblems` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM COMMENT='holds problem reports' AUTO_INCREMENT=44 ;
...
CREATE TABLE `downloaders` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM COMMENT='downloaders voluntary identities' AUTO_INCREMENT=70 ;
