...
def edit_req(request):
    ...
    if request.POST:
        ...
        if not form.is_valid():
            pass
        elif form.cleaned_data['pw1'] != form.cleaned_data['pw2']:
            form.errors['pw2'] = ['Must match password above']
        else:

            object.username = form.cleaned_data['username']
            object.is_staff = True
            object.is_active = form.cleaned_data['is_active']
            ...
            if form.cleaned_data['pw1']:
                object.set_password(form.cleaned_data['pw1'])
