...
def all_query_set(order_by = ('-since',)):
    return User.objects\
               .exclude(acctype='DISABLED')\
               .exclude(acctype='GROUP')\
               .exclude(email__contains="onemctest")\
               .order_by(*order_by)
...
class User(models.Model):
    mcid = models.CharField(max_length = 16,
                            primary_key=True)

    email = models.CharField(null=True, blank=True, max_length=192,
			     db_index=True, unique=True)

    sha1 = models.CharField(null=True, blank=True, max_length=120)

    since = models.DateTimeField(auto_now_add=True)
    first_name = models.CharField(blank=True, max_length=96)
    last_name = models.CharField(blank=True, max_length=96)
    mobile = models.CharField(blank=True, max_length=192)
    smslogin = models.IntegerField(null=True, blank=True)
    updatetime = models.IntegerField()
    ccrlogupdatetime = models.IntegerField()
    chargeclass = models.CharField(blank=True, max_length=765)
    rolehack = models.CharField(blank=True, max_length=765)
    affiliationgroupid = models.IntegerField(null=True, blank=True)
    startparams = models.CharField(blank=True, max_length=765)
    stylesheetUrl = models.CharField(blank=True, max_length=765)
    picslayout = models.CharField(blank=True, max_length=765)
    photoUrl = models.CharField(blank=True, max_length=765)
    ...
    persona = models.CharField(blank=True, max_length=765)
    validparams = models.CharField(blank=True, max_length=765)
    interests = models.CharField(blank=True, max_length=765)
    email_verified = models.DateTimeField(null=True, blank=True)
    mobile_verified = models.DateTimeField(null=True, blank=True)

    # binary data
    enc_skey = models.CharField(blank=True, max_length=12)
