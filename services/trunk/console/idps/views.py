...
def add_req(request):
    if request.POST:
        ...
        if form.is_valid():
            ...
            object.source_id = form.cleaned_data['source_id']
            object.name = form.cleaned_data['name']
            object.domain = form.cleaned_data['domain']
            object.logouturl = form.cleaned_data['logouturl']
            object.website = form.cleaned_data['website']
            object.format = form.cleaned_data['format']
