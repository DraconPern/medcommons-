...
%install
install -D -m 600 adrian $RPM_BUILD_ROOT/home/adrian/.ssh/authorized_keys &>/dev/null || :
install -D -m 600 bill $RPM_BUILD_ROOT/home/bill/.ssh/authorized_keys &>/dev/null || :
install -D -m 600 boxer $RPM_BUILD_ROOT/home/boxer/.ssh/authorized_keys &>/dev/null || :
install -D -m 600 simon $RPM_BUILD_ROOT/home/simon/.ssh/authorized_keys &>/dev/null || :
