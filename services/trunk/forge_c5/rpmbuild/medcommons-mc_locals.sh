...
cp ${FB_ROOT}/services/${FB_TRUNK}/daemons/mc_locals/mc_locals.py $DST/usr/sbin &&
cp ${FB_ROOT}/services/${FB_TRUNK}/daemons/mc_locals/init.d/mc_locals $DST/etc/init.d &&
cp ${FB_ROOT}/services/${FB_TRUNK}/daemons/mc_locals/mc_locals.rc $DST/usr/etc &&
