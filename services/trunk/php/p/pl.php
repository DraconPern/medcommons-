...
/// update query to simon's latest recommendations
	...
	do.ddl_status as dicom_order_status, u.photoUrl,u.expiration_date,u.acctype
...
XXX;
	...
	foreach ($patients as $patient)
	{
		...
		if (($patient->ViewStatus=='Hidden'))
		{
			...
			//https://portal.medcommons.net/p/portal.medcommons.net/images/unknown-user.png
...
<title><?= $LongName ?> Inbox for <?= $email ?> on <?= $ROOT ?></title>
