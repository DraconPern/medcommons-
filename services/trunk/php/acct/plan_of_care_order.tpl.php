  ...
  <Actors>
    <Actor>
      ...
      <Person>
        <Name>
          <CurrentName>
            <Given><?if(isset($givenName) && $givenName):?><?=xmlentities($givenName)?><?endif?></Given>
            <Family><?if(isset($familyName) && $familyName):?><?=xmlentities($familyName)?><?endif?></Family>
          </CurrentName>
        </Name>
        <Gender>
          <Text>Unknown</Text>
    ...
    <Actor>
      <ActorObjectID>UPLOADER</ActorObjectID>
      <InformationSystem>
        <Name>DDL Uploader</Name>
        <Type>DDL Upload from Web Form</Type>
        <Version>V1.0</Version>
      </InformationSystem>
      <Relation><Text>Uploader</Text></Relation>
      <?if(isset($email)):?>
      <EMail>
          <Value><?=xmlentities($email)?></Value>
          <Type><Text>Contact EMail</Text></Type>
      </EMail>
      <?endif;?>
      <Source>
        <Actor>
