...
$mailto = $acCMOEmailAddress;
$subject = "Feedback Form" ;
$formurl = "/feedback/feedback-form.html" ;
$errorurl = "/feedback/feedback-error.html" ;
$thankyouurl = "/feedback/feedback-thankyou.html" ;
...
$headers =
	...
	. "X-Mailer: chfeedback.php 2.16.0" .
	$headersep . 'MIME-Version: 1.0' . $headersep . $content_type ;

if ($use_envsender) {

//echo "Envsender to $mailto sub $subject msg $messageproper hdr $headers";
	mail($mailto, $subject, $messageproper, $headers, $envsender );
}
else {
//echo "Sending to $mailto sub $subject msg $messageproper hdr $headers";
