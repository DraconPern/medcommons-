...
<? /* NOTE: Identities disabled in /include/settings.php */ ?>      
...
<?endif;?>
      <li <?=page('groups')?> ><a href="#groups"><em>Group Members</em></a></li>
      
      <li <?=page('groupsettings')?> ><a href="#groups"><em>Group Settings</em></a></li>
  ...
  <div class='yui-content'>
    ...
    <fieldset>
        ...
        <p>You can request for all data to be deleted from your account.</p>
        
        <p>Account deletion won't take effect immediately.  You will receive
        an email when your request has been processed.</p> 
        
        <p style='margin-top: 1em;'>
            <button onclick='deleteAccount();'>Request Account Deletion</button>
        </p>
    </fieldset>
...
<?if(is_feature_enabled("settings.personalAccount")):?>      
  <div id='personalAccount'>
    ...
    <form method='post' action='gwredir.php' id='documentsForm'>
      <input type='hidden' name='dest' value='<?="PersonalBackup?storageId=$accid&auth=$auth"?>'>
      <h3>Your Documents</h3>

      You can download all your documents as a ZIP archive to save them for future reference.
      <p><input type='submit' value='Download All Documents'></p>
    </form>

    <h3 style='margin-top: 1em;'>Delete Account</h3>
    <p>You can delete all data from your HealthURL.</p>
    <p><button onclick='deleteAccount();'>Delete My HealthURL Now</button></p>
  </div>
<?endif;?>
      ...
      <div style='margin-top: 10px;'>
       ...
       <p><input type='checkbox' name='allowPublicUpload' style='position: relative; top: 2px;' onclick='enableGroupUploads(this.checked);'
           ...
           title='Place a link to this page on your web site or send them by email to enable others to send DICOM to your Group'/> 
            Receive health records with a practice dropbox using
            <a href='<?=getUploadUrl($user->practice,0)?>' title='Place a link to this page on your web site or send them by email to enable others to send DICOM to your Group'>Upload Form A</a>
            or
            <a href='<?=getUploadUrl($user->practice,1)?>' title='Place a link to this page on your web site or send them by email to enable others to send DICOM to your Group'>Upload Form B</a>
       </p>
       
        <?endif;?>
        
       <p >
           <table id='notifyEmailOuter'>
               <tbody>
               <tr>
               <td>Notification Email:  </td>
               <td>
                   <input id='orderNotificationEmail' 
               ...
               <tr> 
                   <td>&nbsp;</td>
                   <td>
                       <span id='emailTip'>Use , to separate multiple addresses</span>
                   </td>
               </tr>
               </tbody>
           </table>
