...
// Is the user logged in and uploading to their own group?
$selfUpload = false;
if($info && $info->practice && ($info->practice->accid == $accid)) {
    dbg("Self upload to group ".$accid);
    $selfUpload = true;
}
