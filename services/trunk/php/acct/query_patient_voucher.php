<?
/**
 * Service for querying whether a patient has a voucher or not and returning
 * its details.   Called by DDL upload page to retrieve voucher details
 * after the DDL creates the voucher.
 */
