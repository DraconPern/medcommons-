...
class resolveDocumentWs extends securedbrestws {
    ...
    try {
        ...
        $allRights = $this->resolveGuid($accid,$guid,$auth,$ctx);
        ...
        if(count($matchingRights) > 0) {
          ...
          if($trackingReference !== false) {
            $tnOutput = $this->xmnest("trackingReference",
        ...
        foreach($matchingRights as $r) {
          $docRefs.="<docRef><guid>$guid</guid>"
            ...
            .$this->xmfield("location",$r->node_id)
