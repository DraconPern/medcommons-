...
/**
 * This class facilitates easy & safe access to the database using
 * PDO.  Do not instantiate it directly, rather, use the factory
 * method:
 * 
 *   $db = DB::get();
 * 
 * In addition to encouraging safe database access by letting you
 * easily pass and bind parameters in a query, this class also
 * throws exceptions for ALL database errors.  Typically you 
 * do NOT need to handle these as the default handler 
 * set in utils.inc.php will catch them and "do the right thing" 
 * (show an appropriate error page).
 * 
 * @author ssadedin
 */
class DB {
