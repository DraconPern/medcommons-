...
public class AccountCreationServiceImpl implements AccountCreationService {
    ...
    public void deleteExpiredAccount(String accid, String deleteStatus) throws ServiceException {
        ...
        try {
            ...
            log.info("Deleting account: " + accid + ", changing to status " + deleteStatus);
            ...
            u.setExpirationDate(new Date());
            s.update(u);
            
            // Delete from any patient lists
            PreparedStatement stmt = s.connection().prepareStatement(
                            "delete from practice_patient where pp_accid = ?");
            stmt.setLong(1, u.getMcid());
            stmt.execute();
