<div class=homecoupon>
  ...
  <li>View, Print and Save the information  
    <a  target='_new' title='open records in new window' href='/<?=$info->accid?>?c=v'>
      <img border='0' src='/images/icon_healthURL.gif' alt='hurlimg'/>Open HealthURL</a>
    </li>
    <?/*
     ...
     */?>
    <li>Download all your Documents - <a href='gwredir.php?dest=<?=urlencode("PersonalBackup?storageId=".$info->accid."&auth=".$info->auth)?>'>Click Here</a></li>
