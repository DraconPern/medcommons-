...
if (isset($_COOKIE['mc'])) { header("Location: ../info.html"); die("Redirecting from groupsetup because user is signed on"); }
...
echo "All is good on resubmitted form in groupsetup.php";
...
die ("Did not redirect in groupsetup");
?>