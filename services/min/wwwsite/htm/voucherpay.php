...
$footer = file_get_contents('_modfooter.html');
...
<form method=post action=voucherpaidcash.php ><input type=hidden name=c value=$v->couponum />
<input type=hidden name=o value=$otp />
<input type=hidden name=p value=p />
<input type=submit value='Paid In Full' name='dopay' />
</form>&nbsp;
<form method=post action=voucherclaim.php ><input type=hidden name=c value=$v->couponum />
<input type=submit value=Cancel />
</form>
</span>
</p>
<h3>Or you can put in the patient's credit card details</h3>
<p>
<form method=post action=voucherpaycc.php ><input type=hidden name=c value=$v->couponum />
...
XXX;
echo $header.$markup.$mid. $footer."</body></html>";
