...
require_once "dbparams.inc.php";  // default params
...
<head>
   ...
   <meta name="robots" content="noindex,nofollow">
    ...
    <title>Alert Notifier - Checks All Servers Every N Seconds</title>
...
<body onload='www_init()'>
    <div id='wrapper'>
        ...
        <h2 id='title'>
			    MedCommons Alerter - Should Run as Cron Job</h2>
        </div>
<div id='content'>
XXX;
echo $top;
...
foreach ($slist as $server)
{
	...
	echo "<h4>$t >> Polling $server </h4>";
	$results = poll($server);
	if ($results) echo "$t >><p>Returned $results</p>";
	else echo"$t >><p>Did Not Return</p>";
