...
function www_init()
{
  ...
  if(getCookie('mc_openid_auth') || getCookie('mc'))
    logout = '<li><a class="menu_logout" href="/acct/logout.php">logout</a></li>';
  else
	...
	if (getCookie('mc'))	{
		...
		showinline('visi');
			document.getElementById('navcontainer').innerHTML = 
		            '<ul id="navlist">'+
                        '<li><a class="menu_home" href="/index.html" title="home">home</a></li>&nbsp;|&nbsp;'+
                        '<li><a class="menu_dashboard" href="/acct/home.php">dashboard</a></li>&nbsp;|&nbsp;'+
                         '<li><a class="menu_search" href="/searchExamples.html">search</a></li>&nbsp;|&nbsp;'+
