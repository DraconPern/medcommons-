...
try {
  ...
  mysql_query($rep) or die("error inserting into patients: ".mysql_error());
	...
	$q = "REPLACE INTO carewalls set wallmcid = '$mcid', wallfbid='$fbid',authorfbid='$fbid',msg='I connected this account for $firstName $lastName to our family',time=$now ";
  ...
  "<html><h4>MedCommons Account $mcid was connected  by facebook user {$u->getFirstName()} {$u->getLastName()}</h4>
    <ul>
      <li>You can access the creator's facebook profile at <a href='http://www.facebook.com/profile.php?id=$fbid'>http://www.facebook.com/profile.php?id=$fbid</li>
