...
function export_fbusers($fbidlist)
{
	// as xml into file
...
//if (isset($_GET['all']) ) {
	...
	//{
		...
		//$pre =' , ';
	//}
	//export_fbusers($all,$user);
	//exit;
//}

if (isset($_GET['export']) ) export_fbusers($_GET['export']);
else die ("204 Export called with invalid arguments");
?>
