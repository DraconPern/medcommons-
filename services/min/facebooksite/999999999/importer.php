...
// Upload XML Facebook Family File
...
//main
	...
	if ( $type =='text/xml')
	{
		...
		if ($zip)
		{	$buf = "
<div class=fbgreybox ><h2>Importing From Saved Family File - $incoming</h2><a href=index.php>back</a></div> ";
	...
	else echo "Only MedCommons Facebook XML files can be uploaded\n<br/>";
	//echo $ret;
