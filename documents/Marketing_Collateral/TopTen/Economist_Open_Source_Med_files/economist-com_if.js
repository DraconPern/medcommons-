var n=navigator;var br0=n.appName.indexOf("Microsoft")!=-1&&parseInt(n.appVersion)>=4&&n.appVersion.indexOf("Macintosh")==-1; var br1=n.appName.indexOf("Microsoft")!=-1&&parseInt(n.appVersion)<4; var br2=n.appName.indexOf("Netscape")!=-1&&parseInt(n.appVersion)>=4&&parseInt(n.appVersion)<5; var br3=n.appVersion.indexOf("Macintosh")!=-1&&parseInt(n.appVersion)<5; var DataColl="http://economistTestCollect.insightfirst.com/data?"; var if7=""; var if8="; path=/"; var ifb=new Date();var CookieId="IFsess"; var w=window;var d=document;

if(typeof if_sid == "undefined" || if_sid == null ) 
{ 
	var if_sid=1; 
}
...
function tax_browser() { 
	...
	if(is_ie5){
		...
		BV="1.0Beta(v48)"; 
		msg+="&if_nt_Browser_Version=1.0Beta(v48)"; 
	} else {
		BV=is_minor; 
...
function ifx(tx)
{
	...
	var sPath = location.href.toLowerCase();
	if(sPath.indexOf(";") != -1) {
		...
		var fu=document.location.pathname.toLowerCase();
		fu = "http://www.economist.com"+fu;
	}

	var if_searchTerm = ""
	var if_searchTermLength = ""

	if(mep1.indexOf("q=") != -1) {
		var pairs = mep1.split("&"); 
		for (var i = 0; i < pairs.length; i++) {    
			if (pairs[i].indexOf("q=") == 0 ) { 
				if_searchTermLength = pairs[i].length;
				if_searchTerm = pairs[i].substring(2,if_searchTermLength);
				mep1 += "&if_nt_InternalSearchTerm=" + if_searchTerm.toUpperCase();;
			}
		}
	}
