...
-(BOOL) UnzipOpenFile:(NSString*) zipFile
{
    ...
    if( _unzFile )
    {
        ...
        { 
            NSLog(@"decompressed %d entries in %s",globalInfo.number_entry,[zipFile UTF8String]);
        }
    } else NSLog(@"could not open file to unzip - %@", zipFile);
...
-(void) OutputErrorMessage:(NSString*) msg
{
    // compiler is complaining, these are optional
