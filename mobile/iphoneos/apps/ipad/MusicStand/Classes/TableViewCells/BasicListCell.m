...
- (void) layoutSubviews
{
    ...
    if (self.hasTitleLabel)
    {
        ...
        tlFrame.size.height = [self.titleLabel sizeThatFits: cvSize].height;
    }
    else
        tlFrame = CGRectZero;
    ...
    {
        tmpHeight = [self.subtitleLabel sizeThatFits: cvSize].height;
    ...
    {
        tmpHeight = [self.info1Label sizeThatFits: cvSize].height;
    ...
    {
        tmpHeight = [self.info2Label sizeThatFits: cvSize].height;
