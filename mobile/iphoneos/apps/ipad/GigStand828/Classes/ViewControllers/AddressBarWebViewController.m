...
#define  ADDRESS_BAR_HEIGHT 31.0f
#define  STATUS_BAR_HEIGHT 20.0f+1.0f
...
-(void) loadView
{
	...
	CGRect topToolbarFrame = CGRectMake(0.0f, STANDARD_NAV_HEIGHT+STATUS_BAR_HEIGHT, 
	...
	CGRect webViewFrame = CGRectMake (0.0f, STANDARD_NAV_HEIGHT + TOP_TOOBAR_HEIGHT, 
									  tmpFrame.size.width ,tmpFrame.size.height-(STANDARD_NAV_HEIGHT+TOP_TOOBAR_HEIGHT+STATUS_BAR_HEIGHT));
...
- (void)viewDidLoad {
    [super viewDidLoad];
	NSString *urlAddress = @"http://gigstand.net/";
