...
@implementation NSDictionary (MCProviderAdditions)

- (NSString *) stringByTrimmingWhitespace:(NSString *)ss
{
    NSMutableString *tmpString = [[ss mutableCopy] autorelease];
...
- (BOOL) boolForKey: (id) key
{
    ...
    if (obj)
    {
        ...
        {
            NSString *str = [self stringByTrimmingWhitespace:(NSString *) obj];
