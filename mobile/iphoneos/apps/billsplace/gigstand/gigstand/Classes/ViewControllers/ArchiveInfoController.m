...
- (void) updateNavigationItemAnimated: (BOOL) animated
{
	self.navigationItem.titleView = [DataManager makeTitleView:[NSString stringWithFormat:@":%@ info",
...
-(NSString *) infoPageHTMLData
{
	...
	NSString *html = [NSString stringWithFormat:
					  @"<html><head><meta name='viewport' content='width=device-width; maximum-scale=1.0' /> </head><body><center><font size='+1' color='red'>No attribution info was supplied by the publisher of:<br/> &lt;%@&gt;<br/></font><font size='+1' color='black'>To remedy, please make an --info--.html file and insert it into this archive</center></body></html>",
					  archive];
	return html;
}
...
- (void) loadView
{
	...
	imgv.image = [ArchivesManager makeArchiveThumbnail: self->archive];
